...
<div class="flex flex-col items-center justify-center h-full bg-white">
    ...
    >
        ...
        <GStatus customClass={'w-full py-1 px-3v text-xl flex flex-row justify-center items-center'} />
        ...
        <button type="submit" class="text-lg py-1 px-3 w-full rounded-sm border-gray-200 hover:border-0">Login</button>
    </form>
</div>
